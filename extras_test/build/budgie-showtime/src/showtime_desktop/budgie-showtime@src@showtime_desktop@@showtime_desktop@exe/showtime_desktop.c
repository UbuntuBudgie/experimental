...
gchar* show_time_log_create_dirs_file (const gchar* subpath,
                                       const gchar* filename);
gchar* show_time_log_currtime (void);
void show_time_log_update_log (const gchar* wtype,
                               const gchar* output);
...
static void _show_time_time_window_update_appearance_g_settings_changed (GSettings* _sender,
                                                                  const gchar* key,
                                                                  gpointer self);
static void show_time_time_window_update_positionsettings (ShowTimeTimeWindow* self);
static void _show_time_time_window_update_positionsettings_g_settings_changed (GSettings* _sender,
                                                                        const gchar* key,
                                                                        gpointer self);
...
static gboolean _show_time_time_window_on_draw_gtk_widget_draw (GtkWidget* _sender,
                                                         cairo_t* cr,
                                                         gpointer self);
static void show_time_time_window_act_onalignment (ShowTimeTimeWindow* self);
static void _show_time_time_window_act_onalignment_g_settings_changed (GSettings* _sender,
                                                                const gchar* key,
                                                                gpointer self);
...
static gboolean _show_time_time_window_setcondition_gtk_widget_configure_event (GtkWidget* _sender,
                                                                         ...
                                                                         gpointer self);
static void show_time_time_window_new_setwindowposition (ShowTimeTimeWindow* self,
                                                  gint x,
                                                  gint y);
...
static gchar* show_time_time_window_get_anchor (ShowTimeTimeWindow* self);
...
gchar*
show_time_log_create_dirs_file (const gchar* subpath,
                                const gchar* filename)
{
	gchar* result = NULL;
	gchar* homedir = NULL;
	...
	homedir = _tmp1_;
	_tmp2_ = g_build_path (G_DIR_SEPARATOR_S, homedir, subpath, filename, NULL);
	fullpath = _tmp2_;
	_tmp3_ = g_file_new_for_path (fullpath);
	file = _tmp3_;
	{
	...
	_tmp4_ = g_build_filename (fullpath, filename, NULL);
	result = _tmp4_;
	_g_object_unref0 (file);
	_g_free0 (fullpath);
	_g_free0 (homedir);
...
gchar*
show_time_log_currtime (void)
{
	gchar* result = NULL;
	GDateTime* logtime = NULL;
	GDateTime* _tmp0_;
	gint hrs = 0;
	GDateTime* _tmp1_;
	gint mins = 0;
	...
	logtime = _tmp0_;
	_tmp1_ = logtime;
	hrs = g_date_time_get_hour (_tmp1_);
	_tmp2_ = logtime;
	mins = g_date_time_get_minute (_tmp2_);
	_tmp3_ = g_strdup ("");
	pre = _tmp3_;
	_tmp4_ = mins;
	if (_tmp4_ < 10) {
	...
	_tmp13_ = _tmp12_;
	_tmp14_ = g_strconcat (_tmp8_, ":", _tmp10_, _tmp13_, NULL);
	_tmp15_ = _tmp14_;
	_g_free0 (_tmp13_);
	_g_free0 (_tmp8_);
	result = _tmp15_;
	_g_free0 (pre);
	_g_date_time_unref0 (logtime);
	return result;
}
...
void
show_time_log_update_log (const gchar* wtype,
                          const gchar* output)
{
	gchar* loglocation = NULL;
	gchar* _tmp0_;
	GFile* logfile = NULL;
	const gchar* _tmp1_;
	GFile* _tmp2_;
	...
	gchar** keeprecords = NULL;
	gint keeprecords_length1 = 0;
	gint _keeprecords_size_ = 0;
	gint _tmp15_;
	gchar* log_output = NULL;
	const gchar* _tmp22_;
	const gchar* _tmp23_;
	gchar* _tmp24_;
	gchar** _tmp25_;
	...
	const gchar* _tmp38_;
	GError * _inner_error_ = NULL;
	g_return_if_fail (wtype != NULL);
	g_return_if_fail (output != NULL);
	_tmp0_ = show_time_log_create_dirs_file (".config/budgie-extras", "showtimelog");
	loglocation = _tmp0_;
	_tmp1_ = loglocation;
	...
	if (!g_file_query_exists (_tmp3_, NULL)) {
		...
		_tmp4_ = logfile;
		_tmp5_ = g_file_create (_tmp4_, G_FILE_CREATE_NONE, NULL, &_inner_error_);
		file_stream = _tmp5_;
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			_g_object_unref0 (logfile);
			_g_free0 (loglocation);
			g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
			g_clear_error (&_inner_error_);
			return;
		}
	...
	_tmp11_ = glue;
	_tmp13_ = _tmp12_ = g_strsplit (_tmp10_, _tmp11_, 0);
	records = _tmp13_;
	records_length1 = _vala_array_length (_tmp12_);
	_records_size_ = records_length1;
	_tmp14_ = records;
	_tmp14__length1 = records_length1;
	length = _tmp14__length1;
	_tmp15_ = length;
	if (_tmp15_ > 40) {
		gchar** _tmp16_;
		...
		_tmp16_ = records;
		_tmp16__length1 = records_length1;
		_tmp17_ = length;
		_tmp18_ = length;
		_tmp19_ = ((_tmp16_ + (_tmp17_ - 40)) != NULL) ? _vala_array_dup1 (_tmp16_ + (_tmp17_ - 40), _tmp18_ - (_tmp17_ - 40)) : ((gpointer) (_tmp16_ + (_tmp17_ - 40)));
		_tmp19__length1 = _tmp18_ - (_tmp17_ - 40);
		keeprecords = (_vala_array_free (keeprecords, keeprecords_length1, (GDestroyNotify) g_free), NULL);
		keeprecords = _tmp19_;
		keeprecords_length1 = _tmp19__length1;
		_keeprecords_size_ = keeprecords_length1;
	} else {
		gchar** _tmp20_;
		...
		_tmp20_ = records;
		_tmp20__length1 = records_length1;
		_tmp21_ = (_tmp20_ != NULL) ? _vala_array_dup2 (_tmp20_, _tmp20__length1) : ((gpointer) _tmp20_);
		_tmp21__length1 = _tmp20__length1;
		keeprecords = (_vala_array_free (keeprecords, keeprecords_length1, (GDestroyNotify) g_free), NULL);
		keeprecords = _tmp21_;
		keeprecords_length1 = _tmp21__length1;
		_keeprecords_size_ = keeprecords_length1;
	}
	_tmp22_ = logtime;
	_tmp23_ = glue;
	_tmp24_ = g_strconcat ("time: ", _tmp22_, "\n", wtype, " ", output, _tmp23_, NULL);
	log_output = _tmp24_;
	_tmp25_ = keeprecords;
	_tmp25__length1 = keeprecords_length1;
	_tmp26_ = log_output;
	_tmp27_ = g_strdup (_tmp26_);
	_vala_array_add1 (&keeprecords, &keeprecords_length1, &_keeprecords_size_, _tmp27_);
	_tmp28_ = glue;
	_tmp29_ = keeprecords;
	_tmp29__length1 = keeprecords_length1;
	_tmp30_ = _vala_g_strjoinv (_tmp28_, _tmp29_, _tmp29__length1);
	newlog = _tmp30_;
	_tmp31_ = logfile;
	...
	_tmp33_ = logfile;
	_tmp34_ = g_file_create (_tmp33_, G_FILE_CREATE_NONE, NULL, &_inner_error_);
	file_stream = _tmp34_;
	if (G_UNLIKELY (_inner_error_ != NULL)) {
		_g_free0 (newlog);
		_g_free0 (log_output);
	...
	_tmp35_ = file_stream;
	_tmp36_ = g_data_output_stream_new ((GOutputStream*) _tmp35_);
	data_stream = _tmp36_;
	_tmp37_ = data_stream;
	_tmp38_ = newlog;
	g_data_output_stream_put_string (_tmp37_, _tmp38_, NULL, &_inner_error_);
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static void
_show_time_time_window_update_positionsettings_g_settings_changed (GSettings* _sender,
                                                                   const gchar* key,
                                                                   gpointer self)
{
	show_time_time_window_update_positionsettings ((ShowTimeTimeWindow*) self);
}
...
static void
_show_time_time_window_act_onalignment_g_settings_changed (GSettings* _sender,
                                                           const gchar* key,
                                                           gpointer self)
{
	show_time_time_window_act_onalignment ((ShowTimeTimeWindow*) self);
}
...
show_time_time_window_construct (GType object_type)
{
	...
	GSettings* _tmp3_;
	gchar* _tmp4_;
	ShowTimeShowTimeappearance* _tmp5_;
	GdkScreen* _tmp6_;
	...
	GSettings* _tmp32_;
	ShowTimeShowTimeappearance* _tmp33_;
	GdkScreen* _tmp34_;
	GdkScreen* _tmp35_;
	...
	_tmp3_ = g_settings_new ("org.ubuntubudgie.plugins.budgie-showtime");
	_g_object_unref0 (show_time_showtime_settings);
	show_time_showtime_settings = _tmp3_;
	_tmp4_ = show_time_time_window_get_dateformat (self);
	_g_free0 (self->priv->dateformat);
	self->priv->dateformat = _tmp4_;
	_tmp5_ = show_time_show_timeappearance_new ();
	_show_time_show_timeappearance_unref0 (self->priv->appearance);
	self->priv->appearance = _tmp5_;
	...
	gtk_window_set_screen ((GtkWindow*) self, _tmp6_);
	...
	show_time_timelabel = _tmp8_;
	_tmp9_ = (GtkLabel*) gtk_label_new ("");
	g_object_ref_sink (_tmp9_);
	_g_object_unref0 (show_time_datelabel);
	show_time_datelabel = _tmp9_;
	_tmp10_ = maingrid;
	_tmp11_ = show_time_timelabel;
	gtk_grid_attach (_tmp10_, (GtkWidget*) _tmp11_, 0, 0, 1, 1);
	_tmp12_ = maingrid;
	_tmp13_ = show_time_datelabel;
	gtk_grid_attach (_tmp12_, (GtkWidget*) _tmp13_, 0, 1, 1, 1);
	_tmp14_ = maingrid;
	gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp14_);
	_tmp15_ = g_strdup ("leftalign");
	_tmp16_ = g_strdup ("showdate");
	_tmp17_ = g_strdup ("twelvehrs");
	_tmp18_ = g_strdup ("xposition");
	_tmp19_ = g_strdup ("yposition");
	_tmp20_ = g_strdup ("linespacing");
	_tmp21_ = g_strdup ("timefontcolor");
	_tmp22_ = g_strdup ("linespacing");
	_tmp23_ = g_strdup ("datefontcolor");
	_tmp24_ = g_strdup ("timefont");
	_tmp25_ = g_strdup ("datefont");
	_tmp26_ = g_new0 (gchar*, 11 + 1);
	_tmp26_[0] = _tmp15_;
	_tmp26_[1] = _tmp16_;
	_tmp26_[2] = _tmp17_;
	_tmp26_[3] = _tmp18_;
	...
	_tmp27__length1 = bind_length1;
	{
		...
		for (s_it = 0; s_it < _tmp27__length1; s_it = s_it + 1) {
			...
			s = _tmp28_;
			{
				...
				const gchar* _tmp30_;
				gchar* _tmp31_;
				_tmp29_ = show_time_showtime_settings;
				_tmp30_ = s;
				_tmp31_ = g_strconcat ("changed::", _tmp30_, NULL);
				g_signal_connect_object (_tmp29_, _tmp31_, (GCallback) _show_time_time_window_update_appearance_g_settings_changed, self, 0);
				_g_free0 (_tmp31_);
				_g_free0 (s);
			}
		}
	}
	_tmp32_ = show_time_showtime_settings;
	g_signal_connect_object (_tmp32_, "changed::draggable", (GCallback) _show_time_time_window_update_positionsettings_g_settings_changed, self, 0);
	show_time_time_window_update_appearance (self);
	_tmp33_ = self->priv->appearance;
	_tmp34_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp35_ = _tmp34_;
	show_time_show_timeappearance_get_appearance (_tmp33_, _tmp35_);
	self->priv->skip_update = TRUE;
	show_time_time_window_update_positionsettings (self);
	self->priv->skip_update = FALSE;
	gtk_widget_set_app_paintable ((GtkWidget*) self, TRUE);
	_tmp36_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp37_ = _tmp36_;
	_tmp38_ = gdk_screen_get_rgba_visual (_tmp37_);
	...
	_tmp40_ = show_time_showtime_settings;
	g_signal_connect_object (_tmp40_, "changed::leftalign", (GCallback) _show_time_time_window_act_onalignment_g_settings_changed, self, 0);
	...
	show_time_time_window_new_setwindowposition (self, 0, 0);
	_tmp41_ = g_thread_new ("oldtimer", _show_time_time_window_run_time_gthread_func, g_object_ref (self));
	_tmp42_ = _tmp41_;
	_g_thread_unref0 (_tmp42_);
...
static gchar*
show_time_time_window_get_anchor (ShowTimeTimeWindow* self)
{
	gchar* result = NULL;
	gint xpos = 0;
	GSettings* _tmp0_;
	...
	if (_tmp2_ == -1) {
		...
		gboolean left = FALSE;
		gboolean _tmp7_;
		left = show_time_time_window_get_leftalign (self);
		_tmp7_ = left;
		if (_tmp7_) {
			gchar* _tmp8_;
			_tmp8_ = g_strdup ("nw");
...
show_time_time_window_act_onalignment (ShowTimeTimeWindow* self)
{
	...
	gint _tmp15_;
	g_return_if_fail (self != NULL);
	_tmp0_ = show_time_time_window_get_anchor (self);
	newanchor = _tmp0_;
	_tmp1_ = show_time_showtime_settings;
	currx = g_settings_get_int (_tmp1_, "xposition");
	_tmp2_ = newanchor;
	if (g_strcmp0 (_tmp2_, "ne") == 0) {
		gint _tmp3_;
		gint _tmp4_;
		gint* _tmp5_;
		gint* _tmp6_;
		...
		gint _tmp7_;
		_tmp3_ = currx;
		_tmp5_ = show_time_time_window_get_windowsize (self, &_tmp4_);
		_tmp6_ = _tmp5_;
		...
		if (g_strcmp0 (_tmp8_, "nw") == 0) {
			...
			gint _tmp13_;
			_tmp9_ = currx;
			_tmp11_ = show_time_time_window_get_windowsize (self, &_tmp10_);
			_tmp12_ = _tmp11_;
			_tmp12__length1 = _tmp10_;
			_tmp13_ = _tmp12_[0];
			currx = _tmp9_ - _tmp13_;
			_tmp12_ = (g_free (_tmp12_), NULL);
		}
	}
	_tmp14_ = show_time_showtime_settings;
	_tmp15_ = currx;
	g_settings_set_int (_tmp14_, "xposition", _tmp15_);
	_g_free0 (newanchor);
}
...
static void
show_time_time_window_new_setwindowposition (ShowTimeTimeWindow* self,
                                             gint x,
                                             gint y)
{
	gint newx = 0;
	...
	const gchar* _tmp2_;
	g_return_if_fail (self != NULL);
	show_time_log_update_log ("walking in\n", "no data yet");
	newx = 0;
	newy = 0;
	_tmp0_ = show_time_time_window_get_anchor (self);
	anchor = _tmp0_;
	_tmp1_ = anchor;
	show_time_log_update_log ("anchor:", _tmp1_);
	_tmp2_ = anchor;
	if (g_strcmp0 (_tmp2_, "nw") != 0) {
		...
		if (_tmp3_) {
			...
			_tmp5_ = show_time_time_window_get_windowsize (self, &_tmp4_);
			winsize = _tmp5_;
			winsize_length1 = _tmp4_;
			_winsize_size_ = winsize_length1;
			_tmp6_ = winsize;
			_tmp6__length1 = winsize_length1;
			_tmp7_ = _tmp6_[0];
			x = _tmp7_;
			_tmp8_ = winsize;
			_tmp8__length1 = winsize_length1;
			_tmp9_ = _tmp8_[1];
			y = _tmp9_;
			winsize = (g_free (winsize), NULL);
		}
		_tmp10_ = anchor;
		if (g_strcmp0 (_tmp10_, "se") == 0) {
			gint* scrdata = NULL;
			gint _tmp11_;
			gint* _tmp12_;
			gint scrdata_length1;
			gint _scrdata_size_;
			gint rightside = 0;
			gint* _tmp13_;
			...
			gint _tmp29_;
			gint _tmp30_;
			_tmp12_ = show_time_time_window_check_res (self, &_tmp11_);
			scrdata = _tmp12_;
			scrdata_length1 = _tmp11_;
			_scrdata_size_ = scrdata_length1;
			_tmp13_ = scrdata;
			_tmp13__length1 = scrdata_length1;
			_tmp14_ = _tmp13_[0];
			_tmp15_ = scrdata;
			_tmp15__length1 = scrdata_length1;
			_tmp16_ = _tmp15_[2];
			rightside = _tmp14_ + _tmp16_;
			_tmp17_ = scrdata;
			_tmp17__length1 = scrdata_length1;
			_tmp18_ = _tmp17_[1];
			_tmp19_ = scrdata;
			_tmp19__length1 = scrdata_length1;
			_tmp20_ = _tmp19_[3];
			downside = _tmp18_ + _tmp20_;
			_tmp21_ = rightside;
			...
			_tmp28_ = _tmp27_;
			show_time_log_update_log ("screendata: ", _tmp28_);
			_g_free0 (_tmp28_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
			_tmp29_ = rightside;
			...
			_tmp30_ = downside;
			newy = (_tmp30_ - 150) - y;
			scrdata = (g_free (scrdata), NULL);
		} else {
			const gchar* _tmp31_;
			_tmp31_ = anchor;
			if (g_strcmp0 (_tmp31_, "sw") == 0) {
				gint* scrdata = NULL;
				gint _tmp32_;
				gint* _tmp33_;
				gint scrdata_length1;
				...
				gint _tmp39_;
				gint _tmp40_;
				_tmp33_ = show_time_time_window_check_res (self, &_tmp32_);
				scrdata = _tmp33_;
				scrdata_length1 = _tmp32_;
				_scrdata_size_ = scrdata_length1;
				_tmp34_ = scrdata;
				_tmp34__length1 = scrdata_length1;
				_tmp35_ = _tmp34_[2];
				newx = _tmp35_ + 150;
				_tmp36_ = scrdata;
				_tmp36__length1 = scrdata_length1;
				_tmp37_ = _tmp36_[1];
				_tmp38_ = scrdata;
				_tmp38__length1 = scrdata_length1;
				_tmp39_ = _tmp38_[3];
				downside = _tmp37_ + _tmp39_;
				_tmp40_ = downside;
				newy = (_tmp40_ - 150) - y;
				scrdata = (g_free (scrdata), NULL);
			} else {
				const gchar* _tmp41_;
				_tmp41_ = anchor;
				if (g_strcmp0 (_tmp41_, "nw") == 0) {
					GSettings* _tmp42_;
					GSettings* _tmp43_;
					_tmp42_ = show_time_showtime_settings;
					newx = g_settings_get_int (_tmp42_, "xposition");
					_tmp43_ = show_time_showtime_settings;
					newy = g_settings_get_int (_tmp43_, "yposition");
				} else {
					const gchar* _tmp44_;
					_tmp44_ = anchor;
					if (g_strcmp0 (_tmp44_, "ne") == 0) {
						GSettings* _tmp45_;
						GSettings* _tmp46_;
						_tmp45_ = show_time_showtime_settings;
						newx = g_settings_get_int (_tmp45_, "xposition") - x;
						_tmp46_ = show_time_showtime_settings;
						newy = g_settings_get_int (_tmp46_, "yposition");
					}
				}
			}
		}
		...
		_tmp54_ = _tmp53_;
		show_time_log_update_log ("new position:", _tmp54_);
		_g_free0 (_tmp54_);
		_g_free0 (_tmp52_);
		_g_free0 (_tmp49_);
		_tmp55_ = newx;
		_tmp56_ = newy;
		gtk_window_move ((GtkWindow*) self, _tmp55_, _tmp56_);
	}
	_g_free0 (anchor);
}
	...
	if (_tmp1_) {
		...
		if (!_tmp2_) {
			...
			if (!show_time_time_window_get_leftalign (self)) {
				...
				gint _tmp5__length1;
				gint _tmp6_;
				_tmp4_ = show_time_time_window_get_windowsize (self, &_tmp3_);
				_tmp5_ = _tmp4_;
			...
			_tmp9_ = newroot_x;
			_tmp10_ = add;
			self->priv->root_x = _tmp9_ + _tmp10_;
			_tmp11_ = newroot_y;
			self->priv->root_y = _tmp11_;
			_tmp12_ = show_time_showtime_settings;
			_tmp13_ = self->priv->root_x;
			g_settings_set_int (_tmp12_, "xposition", _tmp13_);
			_tmp14_ = show_time_showtime_settings;
			_tmp15_ = self->priv->root_y;
			g_settings_set_int (_tmp14_, "yposition", _tmp15_);
		}
	}
}
...
show_time_time_window_update_appearance (ShowTimeTimeWindow* self)
{
	...
	GSettings* _tmp5_;
	GSettings* _tmp6_;
	ShowTimeShowTimeappearance* _tmp7_;
	GdkScreen* _tmp8_;
	GdkScreen* _tmp9_;
	g_return_if_fail (self != NULL);
	al = 1;
	...
	self->priv->showdate = g_settings_get_boolean (_tmp5_, "showdate");
	_tmp6_ = show_time_showtime_settings;
	self->priv->twelvehrs = g_settings_get_boolean (_tmp6_, "twelvehrs");
	_tmp7_ = self->priv->appearance;
	_tmp8_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp9_ = _tmp8_;
	show_time_show_timeappearance_get_appearance (_tmp7_, _tmp9_);
...
show_time_time_window_update_interface (ShowTimeTimeWindow* self)
{
	...
	now = _tmp0_;
	_tmp1_ = now;
	_tmp2_ = self->priv->dateformat;
	_tmp3_ = g_date_time_format (_tmp1_, _tmp2_);
	datestring = _tmp3_;
	_tmp4_ = self->priv->showdate;
	if (!_tmp4_) {
		gchar* _tmp5_;
		_tmp5_ = g_strdup ("");
		_g_free0 (datestring);
	...
	_tmp7_ = now;
	_tmp8_ = show_time_time_window_get_localtime (self, _tmp7_);
	_tmp9_ = _tmp8_;
	_tmp10_ = datestring;
	show_time_show_timeappearance_get_hexcolor (_tmp6_, _tmp9_, _tmp10_);
	_g_free0 (_tmp9_);
	_g_free0 (datestring);
