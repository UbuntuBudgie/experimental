...
using HelloWorldApplet.Widgets;

namespace HelloWorldApplet { 
...
public class Applet : Budgie.Applet{
    ...
    private HelloWorldPopover popover = null;
...
public void peas_register_types(TypeModule module){
    ...
    objmodule.register_extension_type(typeof(Budgie.Plugin), typeof(HelloWorldApplet.Plugin));
